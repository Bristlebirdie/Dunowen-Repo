			        	...
			        	<li><a href="about.html">Dunowen House</a>
			           	...
			           	<li class ="active"><a href="contact.html">Make a Booking</a>
			           	     <ul class="sub-menu">
			           	         ...
			           	         <li class ="active"><a href="offers.html">Special Offers</a></li>
			           	     </ul>
			           	</li>
	        	...
	        	<div class="offers container clearfix">
		        	...
		        	<article>
			        	<div class="offers-pic">
			        		<img src="img/offers-pic.jpg" alt="picture" />
			        	</div>
			        	<div class="offers-intro"><h4>Special Offer</h4>
				        	<div class="date">Available from 19/06/2014 to 19/06/2014</div>
				        	<p>Sed metus ipsum, mollis sit amet consequat id, dictum non odio. Mauris varius est at auctor porttitor. Nullam lobortis cursus fringilla. In molestie nisl vel sollicitudin tempus. Proin egestas nec diam sed faucibus.</p>
