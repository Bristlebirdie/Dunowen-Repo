		...
		<div class="inner-wrap">
			<header>
		        ...
		        <nav id="main-nav" roll="navigation" class="main-nav">
		        	<ul id="menu" class="menu">
			        	...
			        	<li><a href="about.html">Dunowen House</a>
			           		<ul class="sub-menu">
				        		<li><a href="#">History</a></li>
			           	     	<li class="active"><a href="map.html">Map &amp; Directions</a></li>
			           	 	</ul>
			       		</li>
		          	...
		          	<ul class="second-nav">
		          		<li><a href="about.html">Dunowen House</a></li> 
		          	    <li><a href="#">History</a></li> 
		          	    <li class="active"><a href="map.html">Map &amp; Directions</a></li>
		          	</ul>
				</nav>
	        ...
	        <div class="main">		        
	        	...
	        	<div class="container">
			        ...
			        <h4>By Car</h4>
			        <p>Traveling from Cork take the N71 in the direction of Skibbereen. Travel for 32km until you reach the roundabout at outskirts of Clonakilty. Take 2nd exit in direction of Skibbereen, travel past Court House and Wheel Pump until you see Henry O'Leary offices. Take turn left and follow signs for Galley Head / Red Strand / Ardfield. Travel onwards across the Causeway, staying right at end and up a winding hill. Travel for 5km to Ardfield, past church and the The Mountain View House pub.  Follow signs for Wild Atlantic Way (N) for a further 1.5km until you see sign for Sands Cove to left. Take this turn, 500m from here is the entrance to Dunowen House on the left. </p>
